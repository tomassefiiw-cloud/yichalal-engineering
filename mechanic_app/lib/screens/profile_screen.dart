      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        Center(child: Column(children: [
          const CircleAvatar(radius: 40, backgroundColor: AppColors.orangeLight,
              child: Icon(Icons.handyman_rounded, size: 36, color: AppColors.orangeDark)),
          ...
          Container(margin: const EdgeInsets.only(top: 4), padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 3),
            ...
            child: const Text('MECHANIC', style: TextStyle(color: AppColors.orangeDark, fontWeight: FontWeight.w700, fontSize: 11))),
          const SizedBox(height: 8),
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(user.kycVerified ? Icons.verified_rounded : Icons.warning_amber, size: 16,
                color: user.kycVerified ? AppColors.success : AppColors.warn),
            const SizedBox(width: 4),
            Text(user.kycVerified ? 'KYC verified' : 'KYC pending review',
                style: TextStyle(color: user.kycVerified ? AppColors.success : AppColors.warn,
        ...
        TextField(controller: _address, maxLines: 2,
            decoration: const InputDecoration(labelText: 'Workshop address', prefixIcon: Icon(Icons.location_on_outlined))),
        const SizedBox(height: 12),
        TextField(controller: _specialties,
            decoration: const InputDecoration(labelText: 'Specialties (comma-separated)', prefixIcon: Icon(Icons.build_outlined))),
